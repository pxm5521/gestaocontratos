...
**Sobre o tamanho dos contratos**: contratos de até ~110 mil caracteres (a grande maioria — algo como 40-50 páginas densas) são analisados **por inteiro**, sem nenhum corte. Para documentos maiores que isso, o site mostra quantas páginas o PDF tem e deixa você indicar quais trechos (página inicial/final) **considerar** na análise — pode adicionar mais de um trecho, já que os dados relevantes podem aparecer em pontos diferentes do documento. Se você não indicar nenhum trecho, o site tenta localizar sozinho as seções mais relevantes (por palavras-chave em português e inglês, como "Anexo B"/"Exhibit B", "cronograma de pagamento"/"schedule of payments" etc.). Em qualquer um dos dois casos, sempre revise os campos preenchidos antes de salvar, e complete manualmente o que faltar.
